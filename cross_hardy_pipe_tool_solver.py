...
class PipeNetwork:
    ...
    def postprocess(self) -> dict:
        ...
        return {
            ...
            'max_relative_velocity_metric_pipe_id': max_vel_pipe.pipe_id,
            'max_relative_velocity_metric': max_vel_pipe.velocity,
        }
    ...
    def pipes_dataframe(self) -> pd.DataFrame:
        ...
        for pipe in self.pipes.values():
            rows.append({
                ...
                'dP_abs': pipe.dP_abs,
                'relative_velocity_metric': pipe.velocity,
