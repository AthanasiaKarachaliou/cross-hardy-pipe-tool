...
def render_solver_results(summary, nodes_df, pipes_df, map_bytes):
    ...
    row1[2].metric('Max Segment Velocity (ft/s)', f"{summary['max_velocity_ft_s']:.3f}")

    row2 = st.columns(3)
    row2[0].metric('Max Segment Relative Velocity (scfm/in²)', f"{summary['max_relative_velocity_metric']:.3f}")
